...
gallery:
    ...
    - image_url: ch02/dvorak-keyboard.png
      ...
      - image_url: ch02/focusgroup.jpg
      caption: Η αξιοποίηση συμπληρωματικών μεθόδων κατανόησης του χρήστη, όπως οι ομάδες εστίασης βοηθούν στην καλύτερη δυνατή καταγραφή των αναγκών των χρηστών και οδηγεί σε πιο επιτυχημένα προϊόντα.
