...
gallery:
    ...
    - image_url: ch05/Trackers.png
      caption: Ιδιαίτερα δημοφιλής είναι η κατηγορία των φορετών υπολογιστών, οι οποίοι συχνά έχουν τη μορφή έξυπνων ρολογιών, τα οποία με την χρήση αισθητήρων μπορούν να μετρήσουν διάφορα βιομετρικά στοιχεία και να αξιολογήσουν διάφορες δραστηριότητες του χρήστη, όπως  αθλητικές δραστηριότητες, διατροφικές συνήθειες και ποιότητα ύπνου, ώστε να του μεταφέρουν μια ολοκληρωμένη εικόνα της κατάστασης τους.
    - image_url: ch05/MagicCap.jpg
     caption: To Magic Cap ήταν ένα λειτουργικό σύστημα για τον κινητό υπολογισμό, το οποίο χρησιμοποιούσε την εικόνα οικείων αντικειμένων για να προσομοιώσει κάθε δωμάτιο στο οποίο περιηγούταν ο χρήστης εικονικά. Για παράδειγμα στο δωμάτιο «γραφείο» έβρισκε κανείς αντικείμενα που συναντά σε ένα πραγματικό γραφείο, όπως φακέλους, τηλέφωνο, σημειωματάριο κτλ.
     - image_url: ch05/FBStore.jpg
      caption: Το Facebook έχει ξεφύγει από τα πλαίσια ενός κοινού κοινωνικού δικτύου και σε αρκετές περιπτώσεις έχει υποκαταστήσει το ρόλο του Παγκόσμιου Ιστού, φιλοξενώντας ακόμα και εμπορικές δραστηριότητες, όπως αυτές εκδηλώνονται μέσα από τα  Facebook Stores.
