...
gallery:
    ...
    - image_url: ch03/itunes3.png
      ...
      - image_url: ch03/odyssey.png
      caption: Η ιδέα της δυναμικής διάδρασης μεταξύ ανθρώπου-υπολογιστή και η χρήση φυσικού λόγου σαν είσοδο για τον χειρισμό του εμφανίζεται από παλιά σε έργα επιστημονικής φαντασίας, όπως στην θρυλική ταινία «2001: Η Οδύσσεια του Διαστήματος».
